...
window.onload=function(){ 
	...
	var topMargin = 20,
		...
		/* edit with care */
		var chartWidth = tt_w - innerMargin - outerMargin,
			barWidth = tt_h / bar_data.length,
			yScale = d3.scale.linear().domain([0, bar_data.length]).range([0, tt_h-topMargin]),
