...
new JuxtaLearn_Hub_Shortcode_TrickyTopic_Sankey();
class JuxtaLearn_Hub_Shortcode_TrickyTopic_Sankey extends JuxtaLearn_Hub_Shortcode {
	var $shortcode = 'trickytopic_sankey';
	...
	function content() {
        ...
        <script src="<?php echo plugins_url( 'js/sankey-main.js' , JUXTALEARN_HUB_REGISTER_FILE )?>" type="text/javascript" charset="utf-8"></script>
