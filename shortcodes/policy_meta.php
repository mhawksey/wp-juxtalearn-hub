...
new JuxtaLearn_Hub_Shortcode_Policy_Meta();
class JuxtaLearn_Hub_Shortcode_Policy_Meta extends JuxtaLearn_Hub_Shortcode {
	...
	var $defaults = array(
		...
		'footer_terms' => '',
		'no_example_message' => "There is no meta data for this policy",
		'title_tag' => 'h4',
	);

	

	static $post_types_with_example = array('policy');
