<?php 
 $tabs = array(
 			array('name' => 'Terminology',
				  'id'	=> 'term',
				  'description' => 'Problems with use of language and scientific terms, and inconsistent and overlapping terminology.',
 			...
 			array('name' => 'Incomplete Pre-Knowledge',
				  'id'	=> 'pre',
				  'description' => 'Previous understandings that need to be "unlearned" or modified to understand the Tricky Topic',
				  'prompt' => array('pre01' => 'Simplistic understandings that need to be unlearned e.g. imagining atomic structure as balls on sticks suggests space between atoms. ',
				  					'pre02' => 'Understanding  that the student is expected to know already. e.g. to understand genetic drift, need to know about natural selection. Understanding Avogadros number assumes a math understanding of powers of ten.',
									),
				  ),
 			array('name' => 'Essential concepts',
				  ...
				  'prompt' => array('esn01' => 'Knowledge that the student is expected to know already. To understand genetic drift, a student needs to know about natural selection. To calculation Moles in Chemistry using Avogadro\'s number, the student needs to understand powers &amp; ratios in maths',
				  					'esn02' => 'Complementary nowledge the student needs to learn alongside the stumbling block. Understanding genetic drift involves learning about its causes; founder effect and bottleneck effect.',
									),
				  ),
